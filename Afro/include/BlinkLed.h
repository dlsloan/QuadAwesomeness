...
#define BLINK_PIN_NUMBER                (4)//3 = green, 4 = red
#define BLINK_ACTIVE_LOW                (1)

#define BLINK_STATUS_PORT				(1)
#define BLINK_STATUS_PIN				(3)
...
public:
  ...
  inline void
    ...
    {
  #if (BLINK_ACTIVE_LOW)
      GPIO_ResetBits(BLINK_GPIOx(BLINK_STATUS_PORT),
          BLINK_PIN_MASK(BLINK_STATUS_PIN));
  #else
      GPIO_SetBits(BLINK_GPIOx(BLINK_STATUS_PORT),
          BLINK_PIN_MASK(BLINK_STATUS_PIN));
  #endif
    }
